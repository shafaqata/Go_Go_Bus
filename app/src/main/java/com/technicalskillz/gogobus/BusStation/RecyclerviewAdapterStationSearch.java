...
public class RecyclerviewAdapterStationSearch extends RecyclerView.Adapter<RecyclerviewAdapterStationSearch.MyViewHolder> implements Filterable {

    List<Value> list;
    List<Value> listFull;
    Context ctx;

    public RecyclerviewAdapterStationSearch(List<Value> list, Context ctx) {
        this.list = list;
        this.ctx = ctx;
    ...
    private Filter FilterData = new Filter() {
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                list.clear();;
                list.addAll((Collection<? extends Value>) filterResults.values);
